    ...
    return (
      ...
      <div className="relative bg-sky-500/5 dark:bg-sky-400/5">
        ...
        <Row
          ...
          trailing={
            <span
              className="flex max-w-[45%] shrink-0 items-center gap-1 text-muted-foreground"
            ...
            >
              ...
              <InlineText
                ...
                onCancel={() => setEditing(null)}
                className={`font-mono ${transition.field ? "" : "italic text-muted-foreground"}`}
